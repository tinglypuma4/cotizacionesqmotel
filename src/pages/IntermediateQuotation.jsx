...
import './IntermediateQuotation.css';
      ...
      <div className="form-container active">
        ...
        <form id="intermediate-plan-form" onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            {/* Sección de animaciones mejorada */}
            <div className="animations-section">
              <h4>Efectos visuales (seleccione hasta 3):</h4>
              ...
              <p className="animations-selected">
                Efectos seleccionados: {selectedAnimations.length > 0 ? selectedAnimations.join(', ') : 'Ninguno'}
              </p>
            </div>
